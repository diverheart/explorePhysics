...
<body style="background-image: url(img/img.jpg); background-color: rgba(0,0,0,0.4); background-repeat: no-repeat; background-size: cover;">
 ...
 <div class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="myupload.php">Uploads</a></li>
	...
	<div class="container-fluid">
        ...
        <center><h2 style="color: red; font-family: 'Comic Neue', cursive;">Students' Page (ADMIN VIEW)</h2></center>
